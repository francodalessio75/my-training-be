...
@router.post("/sessions/{session_id}/units/{unit_id}/sets", response_model=SessionResponse, status_code=201)
async def add_set(
...
@router.put("/sessions/{session_id}/units/{unit_id}/sets/{set_id}", response_model=SessionResponse)
...
@router.patch("/sessions/{session_id}/units/{unit_id}/sets/reorder", response_model=SessionResponse)
